...
const LEVELS = {
  ...
  3:{name:"Valor agregado",   color:"var(--teal-d)",  deco:IMG.hummingbird2},
  4:{name:"Agendas institucionales", color:"var(--coral-d)", deco:IMG.flamingo}
};

const DATA = [
{id:"obj",temas:"visión misión países miembros bienestar horizonte plataforma regional",lvl:1,t:"Una región más resiliente, integrada y próspera, donde el desarrollo sostenible se traduce en bienestar para cada persona",
...
{id:"t-res",temas:"resiliencia choques desastres clima fiscal contingente emergencia riesgo",lvl:1,t:"resiliente",lead:"Capacidad de absorber choques sin perder la trayectoria de desarrollo.",
...
{id:"t-int",temas:"integración corredores fronteras comercio interconexión regional mercados",lvl:1,t:"integrada",lead:"Mercados, infraestructura y personas mejor conectados.",
...
{id:"t-pro",temas:"prosperidad productividad empleo pymes crecimiento bienestar oportunidades",lvl:1,t:"próspera",lead:"Crecimiento con productividad, empleo y bienestar que llega a cada persona.",
...
{id:"v-int",temas:"fronteras pasos fronterizos corredores logística interconexión comercio regional cuencas compartidas aduanas bienes públicos regionales cooperación técnica",lvl:3,t:"Integración regional pragmática",sub:"Integración por proyectos, no por declaraciones",
...
const TOUR = [
 ...
 {kind:'goal'},
 {kind:'attrs'},
 {kind:'level', lvl:2, kick:'Nivel 2', h:'Fuerzas y espacios donde <em>se abren oportunidades</em>',
  p:'Seis frentes donde se concentra el potencial de la región hacia 2031.'},
 {kind:'level', lvl:3, kick:'Nivel 3', h:'El <em>valor agregado</em> de CAF',
  p:'Lo que el Banco aporta más allá del volumen de financiamiento, y que debe permear toda su acción.'},
 {kind:'level', lvl:4, kick:'Nivel 4', h:'Las <em>agendas institucionales</em> que lo habilitan',
  p:'El trabajo interno que sostiene el funcionamiento del Banco y hace posible la propuesta de valor.'},
 {kind:'close'}
];
